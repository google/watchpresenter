...
if (!authorizeModal) {
    ...
    document.getElementsByTagName("body")[0].insertAdjacentHTML('beforeEnd', '<dialog class="watchpresenter" id="watchpresenterLoadingDialog"><img src="chrome-extension://encadhlpfcdkaheeaeaidbanjfdcolcd/images/loading.gif" alt="Loading..."></img></dialog>')
