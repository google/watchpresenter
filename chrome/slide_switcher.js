...
if (elementToClickOn) {
    ...
    var documentToClickOn = document.evaluate("//*[@class=\"punch-present-iframe\"]", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue.contentDocument;
...
elementToClickOn.dispatchEvent(evt);
